...
//post.text|linebreaksbr
	...
	$FROM = "";
	$TO = "";
	$MAIL_OBJECT = "Message depuis le site";
	$mail_reply_to = "";

    $nb_files = 0;
	
                
                    $val_field = waRetrievePostParameter("nometprenom");

                    $text_message .= "nometprenom"."\n";
                    $text_message .= "---------------\n";

                    if ( false)
                    {
                         $mail_reply_to = $val_field;
                    }


                    if ( )
                    {
                        if (strlen(trim($val_field))==0)
                        {
                            echo json_encode(['success'=>false,'message'=>"Invalid message ! (mandatory constraint)"]);
                            exit();
                        }
                    }
                    ...
                    $text_message .= $val_field."\n";

                    $text_message .= "\n";
                
	
                
                    $val_field = waRetrievePostParameter("emailoutelephone");

                    $text_message .= "emailoutelephone"."\n";
                    $text_message .= "---------------\n";
                    ...
                    $val_field = waRetrievePostParameter("daterendezvous");

                    $text_message .= "daterendezvous"."\n";
                    $text_message .= "---------------\n";
                    ...
                    $val_field = waRetrievePostParameter("prestations");

                    $text_message .= "prestations"."\n";
                    $text_message .= "---------------\n";
                    ...
                    $val_field = waRetrievePostParameter("numeroclient");

                    $text_message .= "numeroclient"."\n";
                    $text_message .= "---------------\n";
                    ...
                    $val_field = waRetrievePostParameter("message");
